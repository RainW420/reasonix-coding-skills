> Source: former chinese code-review skill. This file is reference material for `chinese-conventions`.
...
**对策：** Code Review 对事不对人。用提问式或学习式表达：
